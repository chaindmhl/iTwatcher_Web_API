import os, time, cv2, datetime, math, tempfile
...
from tracking.models import SwerveLog
            ...
            for track in tracker.tracks:
                ...
                if self._intersect(midpoint, previous_midpoint, line2[0], line2[1]) and track.track_id not in already_counted:
                        ...
                        if angle > 0 or angle < 0:
                            ...
                            swerve_log = SwerveLog.objects.create(
                                filename = image_name,
                            ...
                            swerve_log.plate_image.save(image_name, open(plate_img_temp.name, 'rb'))
                            swerve_log.warped_image.save(image_name, open(warped_plate_temp.name, 'rb'))
                            # Save frame_image using ImageField
                            swerve_log.frame_image.save(image_name, open(frame_img_temp.name, 'rb'))
